...
#define configOS_MIN_STACK_DEEP               	1024
#define configOS_SUPPORT_RUNTIME_STATUS         1
#define configOS_HEAP_SIZE						(1024*1024)
...
#define configOS_STDOUT_BUF_SIZE				(1024*32)
...
#ifdef STM32H743xx
#define CPU_TYPE_STM32_CM7						1
#define __CPU_FUNC_ATTRIBUTE__				__attribute__((section(".itcmram")))
#endif



#ifndef __CPU_FUNC_ATTRIBUTE__
#define __CPU_FUNC_ATTRIBUTE__
#endif
